...
$jsArray2 = "var harga_modal = new Array();";  
 ?>
 <h1 style="font-family:impact; text-align:center; letter-spacing:7px; color:skyblue;">Masukan Data</h1><br>
<!-- isinya -->
<form method="post">
  <div class="container">
<div class="row">
  ...
  <div class="col-sm-8 col-md-8 col-lg-3 mb-3">
    ...
    <div class="input-group-append">
      ...
      <button type="submit" name="InputCart" class="btn btn-success btn-sm">Simpan</button>
    </div>
  </div>
  </div>
...
<footer style="text-align:center; color:grey;">&copy;Desaigner by YayanRPLsatu</footer>
<!-- end isinya -->
...
<div class="modal fade" id="Exit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <i class="fas fa-exclamation-triangle fa-4x text-info mb-3"></i>
